...
)  ENGINE = InnoDB AUTO_INCREMENT =10000 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_menu`  (
                             `MENUID` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '菜单/按钮ID',
                             `PARENTID` bigint(10) DEFAULT NULL COMMENT '上级菜单ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单表' ROW_FORMAT = Dynamic;


/*DROP TABLE IF EXISTS `sys_authority`;
CREATE TABLE `sys_authority`  (
                                  `ID` bigint(10) NOT NULL AUTO_INCREMENT COMMENT 'ID',
                                  `ORDERID` bigint(4)  NOT NULL COMMENT '排序字段',
                                  `POWERLABEL` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci  NOT NULL COMMENT '权限名称',
                                  `POWERTYPE` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限类型',
                                  `POWERNAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '权限id',
                                  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色权限表' ROW_FORMAT = Dynamic;
*/
-- -------------------------------------------------------------------------------------------------------------------------
...
CREATE TABLE `sys_role_menu`  (
                                  `ROLEID` bigint(10) NOT NULL COMMENT '角色ID',
                                  `MENUID` bigint(10) NOT NULL COMMENT '菜单ID'
...
CREATE TABLE `t_job`  (
                          `JOBID` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '任务id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务表' ROW_FORMAT = Dynamic;

-- -----------------------------------------------------------------------------------------------------------------------

DROP TABLE IF EXISTS `t_job_log`;
CREATE TABLE `t_job_log`  (
                              `LOGID` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '任务日志id',
                              `JOBID` bigint(10) NOT NULL COMMENT '任务id',
                              ...
                              `CREATETIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
                              PRIMARY KEY (`LOGID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '调度日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_vehicle_type` (
                                  `VEHICLETYPEID` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '车辆类型id',
                                  ...
                                  `CENTERLENGHT` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci  COMMENT '转弯长度',
                                  primary key (`VEHICLETYPEID`)   USING BTREE
)  ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_vehicle` (
                             `VEHICLEID` bigint(10) NOT NULL AUTO_INCREMENT COMMENT '车辆id',
                             `VEHICLENO` bigint(5)  NOT NULL COMMENT '车辆编号',
...
)  ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_user_vehicle`  (
                                   `USERID` bigint(10) NOT NULL COMMENT '用户ID',
                                   `VEHICLEID` bigint(10) NOT NULL COMMENT '车辆ID'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户车辆关联表' ROW_FORMAT = Dynamic;

-- -----------------------------------------------------------------------------------------------------------------------

DROP TABLE IF EXISTS `t_vehicle_vehicleType`;
CREATE TABLE `t_vehicle_vehicleType`  (
                                          `VEHICLETYPEID` bigint(10) NOT NULL COMMENT '车辆类型ID',
                                          `VEHICLEID` bigint(10) NOT NULL COMMENT '车辆ID'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车辆类型车辆关联表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 0 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '矿物种类表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_area_mineral` (
                                  ...
                                  `ADDTIME` DATETIME(0) NOT NULL COMMENT  '添加时间',
                                  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 0 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '卸载区和矿物对应表' ROW_FORMAT = DYNAMIC;
-- -----------------------------------------------------------------------------------------------------------------------
####地图管理
...
CREATE TABLE `t_map_info` (
                              ...
                              PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 0 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '地图信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_vehicleLive` (
                                 ...
                                 `EXPIRETIME` bigint(5)   COMMENT '有效时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 0 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '车辆实时数据表' ROW_FORMAT = DYNAMIC;
##添加约束
alter table `t_vehicleLive` add unique  `time_unique` (ADDTIME);
...
) ENGINE = InnoDB AUTO_INCREMENT = 0 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '调度单元表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 0 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '调度任务规则表' ROW_FORMAT = DYNAMIC;
...
(
    ...
    `UPDATETIME` datetime(0)    COMMENT '产生时间',
     primary key (`ID`) using btree
)ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '实时调度信息表' ROW_FORMAT = DYNAMIC;
...
(
    ...
    primary key (`ID`) using btree
)ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '实时调度状态变更表' ROW_FORMAT = DYNAMIC;
-- ---------------------------------------------------------------------------------
##消息盒子
...
)ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '故障表' ROW_FORMAT = DYNAMIC;
...
)ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET =UTF8 COLLATE = utf8_general_ci COMMENT '审批表' ROW_FORMAT = DYNAMIC;
