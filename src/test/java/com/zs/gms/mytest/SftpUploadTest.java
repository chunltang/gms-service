...
public class SftpUploadTest {
    ...
    //主机ip
    private static String host = "192.168.42.14";
    ...
    public static void main(String[] args) {
       ...
       List<String> cmds=new ArrayList<>();
        ...
        //cmds.add("sh docker.sh ycc  gms-1.0.1 gms-1.0.1 9999 server3");
        //cmds.add("sh docker.sh dac `docker ps | grep gms-1.0.2 |awk '{print $1}'`  `docker images | grep gms-1.0.2 |awk '{print $3}'` gms-1.0.2 gms-1.0.2 9998 server4");
